            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        />
                        <label className="label">
                            {errors.firstName?.type === 'required' && <p className='text-red-600' role="alert">{errors.password.message}</p>}
                            {errors.firstName?.type === 'pattern' && <p className='text-red-600' role="alert">{errors.password.message}</p>}
                        </label>
                    </div>
                    ...
                    <button value='submit' className="btn btn-outline uppercase">CONTINUE WITH GOOGLE</button>
                </form>
            </div>
