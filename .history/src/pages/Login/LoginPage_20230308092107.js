        ...
        <div className='grid grid-cols-1 justify-items-center '>
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <input type="btn" name='btn' onClick={() => useSignInWithGoogle} placeholder="CONTINUE WITH GOOGLE" className="btn btn-white text-accent input input-bordered w-full max-w-xs" />
                </div>
            </div>
        </div>
    );
