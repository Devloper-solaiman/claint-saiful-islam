    ...
    return (
        <div className='grid grid-cols-1 justify-items-center mt-24'>
            <div className="form-control w-full max-w-xs">
                <span className='text-gray-400 text-center justify-center mb-3'>wright your Email and submit then check your email and update your Password</span>
            ...
            <Link to='/LoginPage' className='uppercase w-44 btn btn-secondary' >go login</Link>
        </div>
    );
};
